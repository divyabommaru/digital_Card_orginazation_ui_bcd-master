...
export default function StaffCardForm() {
  ...
  /* ================= UI (now with full dark/light mode support) ================= */
      ...
      <div className="grid grid-cols-1 xl:grid-cols-2 gap-10 p-4 md:p-6 lg:p-8">
        ...
        >
          ...
          <div className="p-8 space-y-10">
            ...
            <FormSection title="Images" subtitle="Profile & cover visuals">
              <div className="md:col-span-2">
                <div className="relative w-full h-56 rounded-2xl border-2 border-dashed border-[hsl(var(--border))] overflow-hidden bg-[hsl(var(--bg-secondary))] hover:border-[hsl(var(--accent))] transition-all">
                  <label className="absolute inset-0 cursor-pointer flex flex-col items-center justify-center gap-4">
                    {coverPreview ? (
                      ...
                      <>
                        <div className="text-6xl text-[hsl(var(--accent))] opacity-90 drop-shadow-md">
                          📸
                        </div>
                        <div className="text-xl font-semibold text-[hsl(var(--text-primary))] text-center px-6 drop-shadow-md">
                          Upload cover image
                        </div>
                        <div className="text-sm text-[hsl(var(--text-muted))] text-center px-8">
                  ...
                  <label className="absolute -bottom-14 left-8 cursor-pointer group">
                    <div className="w-28 h-28 rounded-full border-4 border-[hsl(var(--card-bg))] shadow-2xl overflow-hidden bg-[hsl(var(--card-bg))] ring-4 ring-offset-4 ring-offset-[hsl(var(--card-bg))] ring-[hsl(var(--accent)/0.8)] group-hover:ring-[hsl(var(--accent))] transition-all">
                      {profilePreview ? (
                        <img
                          src={profilePreview}
                          alt="Profile preview"
                        ...
                        <div className="flex flex-col items-center justify-center h-full text-sm text-[hsl(var(--text-primary))] font-medium gap-1.5 bg-gradient-to-b from-transparent to-black/40">
              ...
              {form.brochures.length > 0 && (
                <div className="grid grid-cols-2 sm:grid-cols-3 gap-4 mt-4">
                  {form.brochures.map((b, i) => (
                    <div
                      key={i}
                      className="border border-[hsl(var(--border))] rounded-2xl p-3 text-xs text-center hover:shadow-md transition-all bg-[hsl(var(--bg-secondary))]"
                    >
              ...
              {form.community_images.length > 0 && (
                <div className="grid grid-cols-2 sm:grid-cols-3 gap-4 mt-4">
                  {form.community_images.map((img, i) => (
                    <div
                      key={i}
                      className="border border-[hsl(var(--border))] rounded-2xl p-3 text-xs text-center bg-[hsl(var(--bg-secondary))]"
                    >
                      <img
                        src={img.file ? URL.createObjectURL(img.file) : img.url}
                        alt={`Community preview ${i + 1}`}
...
/* ================= HELPERS (updated for dark/light mode) ================= */
