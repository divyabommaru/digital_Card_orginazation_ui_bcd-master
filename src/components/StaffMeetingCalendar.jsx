...
//     try {
//       const res = await api.get("/orginazation-dashboard/my-meetings");
...
//         `/orginazation-dashboard/meetings/${activeMeeting.id}/confirm`,
//       );
...
//         `/orginazation-dashboard/meetings/${activeMeeting.id}`,
//       );
...
//                 Requested by:{" "}
//                 <span className="font-medium">{activeMeeting.name}</span>
//               </p>
