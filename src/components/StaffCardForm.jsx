    ...
    <AdminLayout>
      <div className="grid grid-cols-1 xl:grid-cols-2 gap-10 p-4 md:p-6 lg:p-8">
        ...
        >
          ...
          {/* BODY */}
          <div className="p-8 space-y-10">
            {/* IMAGES - IMPROVED DARK MODE VISIBILITY */}
            <FormSection title="Images" subtitle="Profile & cover visuals">
              <div className="md:col-span-2">
            ...
            {/* COMPANY */}
            <FormSection title="Company Details">
              <Input name="company_name" label="Company Name" value={form.company_name} onChange={handleChange} />
              <Input name="company_email" label="Company Email" value={form.company_email} onChange={handleChange} />
            </FormSection>

            {/* BROCHURES */}
            <FormSection title="Company Brochures">
              <UploadBox label="Upload brochures (PDF)" accept="application/pdf" multiple onChange={handleBrochures} icon="📄" />

              {form.brochures.length > 0 && (
                <div className="grid grid-cols-2 sm:grid-cols-3 gap-4 mt-4">
                  {form.brochures.map((b, i) => (
                    <div key={i} className="border border-[hsl(var(--border))] rounded-2xl p-3 text-xs text-center hover:shadow-md transition-all bg-[hsl(var(--bg-secondary))]">
                      ...
                      <input
                        ...
                        className="mt-2 w-full border border-[hsl(var(--border))] rounded-lg px-2 py-1.5 text-sm bg-[hsl(var(--card-bg))] text-[hsl(var(--text-primary))]"
                      />
                    </div>
                  ))}
                </div>
            ...
            {/* COMMUNITY */}
            <FormSection title="Community Images">
              <UploadBox label="Upload community images" accept="image/*" multiple onChange={handleCommunityImages} icon="🖼️" />

              {form.community_images.length > 0 && (
                <div className="grid grid-cols-2 sm:grid-cols-3 gap-4 mt-4">
                  {form.community_images.map((img, i) => (
                    <div key={i} className="border border-[hsl(var(--border))] rounded-2xl p-3 text-xs text-center bg-[hsl(var(--bg-secondary))]">
                      <img
                        src={URL.createObjectURL(img.file)}
                        alt={`Community preview ${i + 1}`}
            ...
            <FormSection title="Basic Info">
              ...
              <Input name="designation" label="Designation" value={form.designation} onChange={handleChange} />
            </FormSection>
            ...
            {/* SERVICES */}
            <FormSection title="Services">
              <Textarea label="Comma or new line separated" value={serviceInput} onChange={handleServicesChange} />
            </FormSection>

            {/* SOCIAL MEDIA */}
            <FormSection title="Social Media">
              <Input name="linkedin" label="LinkedIn URL" value={form.socials.linkedin} onChange={(e) => setForm({ ...form, socials: { ...form.socials, linkedin: e.target.value } })} />
              <Input name="instagram" label="Instagram URL" value={form.socials.instagram} onChange={(e) => setForm({ ...form, socials: { ...form.socials, instagram: e.target.value } })} />
              <Input name="facebook" label="Facebook URL" value={form.socials.facebook} onChange={(e) => setForm({ ...form, socials: { ...form.socials, facebook: e.target.value } })} />
              <Input name="youtube" label="YouTube URL" value={form.socials.youtube} onChange={(e) => setForm({ ...form, socials: { ...form.socials, youtube: e.target.value } })} />
            </FormSection>
          </div>
        ...
        <div className="flex justify-center">
          <div className="w-full max-w-[380px] bg-[hsl(var(--card-bg))] rounded-3xl shadow-2xl overflow-hidden border border-[hsl(var(--border))]">
            ...
            <div className="pt-16 px-6 pb-8 space-y-6">
              ...
              {form.services.length > 0 && (
                <>
                  ...
                  <ul className="list-disc list-inside text-sm space-y-1.5 text-[hsl(var(--text-secondary))]">
                    {form.services.map((s, i) => <li key={i}>{s}</li>)}
                  </ul>
                </>
              )}
              ...
              {(form.socials.linkedin || form.socials.instagram || form.socials.facebook || form.socials.youtube) && (
                <>
                  <Divider />
                  <div className="flex gap-5 pt-3">
                    {form.socials.linkedin && <SocialIcon url={form.socials.linkedin} label="in" color="bg-[#0A66C2]" />}
                    {form.socials.instagram && <SocialIcon url={form.socials.instagram} label="📸" color="bg-gradient-to-br from-[#f58529] via-[#dd2a7b] to-[#8134af]" />}
                    {form.socials.facebook && <SocialIcon url={form.socials.facebook} label="f" color="bg-[#1877F2]" />}
                    {form.socials.youtube && <SocialIcon url={form.socials.youtube} label="▶" color="bg-[#FF0000]" />}
                  </div>
                </>
              )}
            </div>
...
//       const debugDetails =
//         error.response?.data?.exception || error.response?.data?.trace || "";

//       errorAlert(
//         "Error",
//         backendMessage + (debugDetails ? `\n\n${debugDetails}` : ""),
//       );
//     }
//   };
